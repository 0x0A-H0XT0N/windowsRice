...
TODO: ship profile.js (firefox), ship nighttab config (firefox), check other rices on workspace, add the last firefox extensions, add dedicated list for firefox extensions
